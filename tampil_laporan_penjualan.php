                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      $query = "SELECT * FROM penjualan where DATE(tanggal_transaksi) BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY id_penjualan DESC";
                      ...
                      <tfoot>
                        <?php 
                         $query_total = "SELECT sum(total_harga) as total_keseluruhan FROM penjualan where DATE(tanggal_transaksi) BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
                    ...
                    <form action="cetak_laporan_penjualan.php" method="post" target="_blank">
