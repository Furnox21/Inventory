  ...
  <table id="example1" class="table">
                 ...
                 <tbody>
                    ...
                    $tanggal_awal = $_POST['tanggal_awal'];
                      $tanggal_akhir = $_POST['tanggal_akhir'];
                        $no = 1;
                        $sql1 = mysqli_query($conn, "SELECT * FROM penjualan where DATE(tanggal_transaksi) BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY id_penjualan DESC");
                ...
                <tfoot>
                <?php
                $get_total = mysqli_query($conn,"SELECT sum(total_harga) as total_keseluruhan FROM penjualan where DATE(tanggal_transaksi) BETWEEN '$tanggal_awal' AND '$tanggal_akhir'"); 
