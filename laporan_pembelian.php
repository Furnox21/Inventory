                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tfoot>
                        <?php 
                         $query_total = "SELECT sum(p.harga_beli*p.jumlah_pembelian) as total_keseluruhan FROM pembelian p";
                    ...
                    <a href="cetak_laporan_pembelian_all.php" class="btn btn-success" style="margin-left: 20px" target="blank" ><i class="fas fa-print"></i> CETAK </a>
                  </div>
                </div>
              </div>
            </div>
